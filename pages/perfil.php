...
if (isset($_POST['enviar'])) {
    ...
    if (count($erro) == 0) {
        ...
        $sql_code = "UPDATE usuarios SET nome = $nome, email = $email WHERE id = $id";

        if(!empty($senha)) {
            $sql_code = "UPDATE usuarios SET nome = $nome, email = $email, senha = '$senha' WHERE id = $id";
        ...
        <div class="col-lg-6">
            <div class="page-header-title">
                <div class="d-inline">
                    ...
                    <span>Preencha as informações e clique em Salvar para cadastrar um novo usuário.</span>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
