...
if(isset($_POST['adquirir'])) {
    ...
    // verificar se o usuário possuí créditos para comprar o curso
    ...
    if($preco_do_curso > $creditos_do_usuario) {
        $erro = "Você não possui créditos suficientes para adquirir esse curso";
    } else {
        $mysqli->query("INSERT INTO relatorio (id_usuario, id_curso, valor, data_compra) VALUES ('$id_user', '$id_curso', '$preco_do_curso', NOW())") or die($mysqli->error);
    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                <div class="d-inline">
                    <h4>Loja Gurunator</h4>
                    <span>Adquira os cursos usando o seu crédito disponível!</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
