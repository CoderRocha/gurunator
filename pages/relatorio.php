                                ...
                                <?php if ($num_relatorios == 0) { ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $relatorio['id_usuario']; ?></td>
                                            <td><?php echo $relatorio['id_curso']; ?></td>
                                            <td><?php echo date('d/m/Y:H:i:s', strtotime($relatorio['data'])); ?></td>
                                            <td>R$ <?php echo number_format($relatorio['valor'], 2, ',', '.'); ?></td>
                                            <td><a href="index.php?p=editar_usuario&id="<?php echo $relatorio['id']; ?>>Editar</a> | <a href="index.php?p=deletar_usuario&id=<?php echo $usuario['id']; ?>">Deletar</a></td>
                                        </tr>
                                <?php }
                                } ?>
                            </tbody>
